...
const CollectTerm = () => {
  return (
    <TermBox>
      <Div>
        일공이오 ('http://'이하 "회사") 은(는) 개인정보보호법에 따라 정보주체의
        개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수
        있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
      </Div>
      <Div>■ 이 개인정보처리방침은 2023년 12월 27일 부터 적용됩니다.</Div>
      <Number>제1조(개인정보의 처리 목적)</Number>
      <Cdiv>
        <ul>
          <li>
            ...
            <ol>
              ...
              <li>
                재화 또는 서비스 제공 서비스 제공, 콘텐츠 제공을 목적으로
                개인정보를 처리합니다.
              </li>
              <li>
                마케팅 및 광고에의 활용 광고성 정보 제공, 서비스의 유효성 확인
                등을 목적으로 개인정보를 처리합니다.
              </li>
            </ol>
          </li>
      ...
      <Number>제2조(개인정보의 처리 및 보유 기간)</Number>
      <Cdiv>
        <ul>
          <li>
          ...
          <li>
            ...
            <ol>
              <li>
                ...
                <span style={{ fontWeight: "bold" }}>탈퇴 시</span> 까지 위
                이용목적을 위하여 보유.이용됩니다.
      ...
      <Number>제3조(처리하는 개인정보의 항목)</Number>
      <Cdiv>
        <ul>
          <li>"회사"은(는) 다음의 개인정보 항목을 처리하고 있습니다.</li>
          <ol>
            <li>
              홈페이지 회원가입 및 관리 필수항목 : 이메일, 비밀번호, 이름,
              닉네임, 전화번호, 주소 카카오 간편가입 : [필수] 이메일, 닉네임,
              프로필 사진
            </li>
          </ol>
        </ul>
      </Cdiv>
      <Number>제4조(개인정보의 파기절차 및 파기방법)</Number>
      <Cdiv>
        <ul>
          <li>
          ...
          <li>
            ...
            <ol>
              <li>
                파기절차 "회사"은(는) 파기 사유가 발생한 개인정보를 선정하고,
      ...
      <Number>제6조(개인정보의 안전성 확보조치에 관한 사항)</Number>
      <Cdiv>
        <ul>
          <li>
      ...
      <Number>제8조(행태정보의 수집·이용·제공 및 거부 등에 관한 사항)</Number>
      <Cdiv>
        <ul>
          <li>
            행태정보의 수집·이용·제공 및 거부등에 관한 사항 "회사"은(는) 온라인
            맞춤형 광고 등을 위한 행태정보를 수집·이용·제공하지 않습니다.
          </li>
        </ul>
      </Cdiv>
      <Number>제9조 (개인정보 보호책임자에 관한 사항)</Number>
      <Cdiv>
        <ol>
          <li>
            ...
            <ul className="ul_disc">
              <li>
                개인정보 보호책임자 성명 :양웅열, 이혜원, 서용욱, 이하림, 안준영
                직책 : 직급 : 연락처 annaidle99@gmail.com ※ 개인정보 보호
                담당부서로 연결됩니다.
              </li>
            </ul>
          </li>
      ...
      <Number>제10조(정보주체의 권익침해에 대한 구제방법)</Number>
      <Cdiv>
        <ul>
          <li>
      ...
      <Number>제11조(개인정보 처리방침 변경)</Number>
      <Div>■ 이 개인정보처리방침은 2023년 12월 27일 부터 적용됩니다.</Div>
    </TermBox>
  );
};
export default CollectTerm;
